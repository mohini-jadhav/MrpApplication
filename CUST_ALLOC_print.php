...
require_once("include/CUST_ALLOC_variables.php");
...
$page_layouts["CUST_ALLOC_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "CUST_ALLOC" );
