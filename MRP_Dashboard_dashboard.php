...
require_once("include/MRP_Dashboard_variables.php");
...
$page_layouts["MRP_Dashboard_dashboard"] = $layout;
...
$params["templatefile"] = GetTemplateName("MRP_Dashboard", "dashboard");
