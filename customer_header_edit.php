...
require_once ("include/customer_header_variables.php");
...
$page_layouts ["customer_header_edit"] = $layout;
...
$page_layouts ["customertechnology_list"] = $layout;
...
$keys = array ();
$keys ["OracIeID"] = postvalue ( "editid1" );
