...
require_once("include/employee_auth_variables.php");
...
$page_layouts["employee_auth_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "employee_auth" );
