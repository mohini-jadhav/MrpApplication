...
require_once("include/customer_stage_variables.php");
...
$page_layouts["customer_stage_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "customer_stage" );
