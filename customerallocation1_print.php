...
require_once("include/customerallocation1_variables.php");
...
$page_layouts["customerallocation1_print"] = $layout;
...
$page_layouts["customer_header_masterprint"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "customerallocation1" );
