...
require_once("include/Allocation_Dashboard_New_variables.php");
...
$layout = new TLayout("dashboard", "FusionAqua", "MobileAqua");
$layout->version = 2;
...
$page_layouts["Allocation_Dashboard_New_dashboard"] = $layout;
...
$params["templatefile"] = GetTemplateName("Allocation_Dashboard_New", "dashboard");
