...
require_once("include/customer_platform_variables.php");
...
$page_layouts["customer_platform_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "customer_platform" );
