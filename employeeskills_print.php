...
$page_layouts["employeeskills_print"] = $layout;
...
$page_layouts["employee_header_masterprint"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "employeeskills" );
