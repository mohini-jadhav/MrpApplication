...
$layout = new TLayout("remind2", "FusionAqua", "MobileAqua");
$layout->version = 2;
...
if (@$_POST["btnSubmit"] == "Remind")
{
	...
	if( $pageObject->checkCaptcha() )
	{
		...
		if($tosearch)
		{
			...
			$strSQL = $selectClause." from ".$pageObject->connection->addTableWrappers("users")." where ".$sWhere;
...
$layout = new TLayout("remind_success2", "FusionAqua", "MobileAqua");
$layout->version = 2;
$layout->blocks["top"] = array();
