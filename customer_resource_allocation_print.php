...
require_once("include/customer_resource_allocation_variables.php");
...
$page_layouts["customer_resource_allocation_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "customer_resource_allocation" );
