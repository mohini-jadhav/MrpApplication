...
function checkTableName($shortTName, $type = false) {
	...
	if ("customer_header" == $shortTName && ($type === false || ($type !== false && $type == 0)))
		return true;
	if ("customer_platform" == $shortTName && ($type === false || ($type !== false && $type == 0)))
		return true;
	if ("customer_stage" == $shortTName && ($type === false || ($type !== false && $type == 0)))
		return true;
	if ("customer_resource_allocation" == $shortTName && ($type === false || ($type !== false && $type == 0)))
		return true;
	if ("employee_auth" == $shortTName && ($type === false || ($type !== false && $type == 0)))
		return true;
	if ("employee_header" == $shortTName && ($type === false || ($type !== false && $type == 0)))
		return true;
	if ("lookup" == $shortTName && ($type === false || ($type !== false && $type == 0)))
		return true;
	...
	if ("admin_users" == $shortTName && ($type === false || ($type !== false && $type == 1)))
		return true;
	if ("customerallocation" == $shortTName && ($type === false || ($type !== false && $type == 0)))
		return true;
	if ("backup" == $shortTName && ($type === false || ($type !== false && $type == 0)))
		return true;
	if ("database" == $shortTName && ($type === false || ($type !== false && $type == 0)))
		return true;
	if ("application" == $shortTName && ($type === false || ($type !== false && $type == 0)))
		return true;
	if ("stage" == $shortTName && ($type === false || ($type !== false && $type == 0)))
		return true;
	if ("CUST_ALLOC" == $shortTName && ($type === false || ($type !== false && $type == 1)))
		return true;
	if ("calandar" == $shortTName && ($type === false || ($type !== false && $type == 0)))
		return true;
	if ("MRP_Dashboard" == $shortTName && ($type === false || ($type !== false && $type == 4)))
		return true;
	if ("allocation" == $shortTName && ($type === false || ($type !== false && $type == 0)))
		return true;
	if ("View" == $shortTName && ($type === false || ($type !== false && $type == 1)))
		return true;
	if ("skillstable" == $shortTName && ($type === false || ($type !== false && $type == 0)))
		return true;
	if ("employeeskills" == $shortTName && ($type === false || ($type !== false && $type == 0)))
		return true;
	if ("skilllevel" == $shortTName && ($type === false || ($type !== false && $type == 0)))
		return true;
	if ("category" == $shortTName && ($type === false || ($type !== false && $type == 0)))
		return true;
	if ("customer_Geotag" == $shortTName && ($type === false || ($type !== false && $type == 1)))
		return true;
	if ("tbl_test_center" == $shortTName && ($type === false || ($type !== false && $type == 0)))
		return true;
	if ("tbl_director" == $shortTName && ($type === false || ($type !== false && $type == 0)))
		return true;
	if ("stage2" == $shortTName && ($type === false || ($type !== false && $type == 0)))
		return true;
	if ("tbl_categorytechnology" == $shortTName && ($type === false || ($type !== false && $type == 0)))
		return true;
	if ("tbl_technologycustomer" == $shortTName && ($type === false || ($type !== false && $type == 0)))
		return true;
	if ("customertechnology" == $shortTName && ($type === false || ($type !== false && $type == 0)))
		return true;
	if ("tbl_role" == $shortTName && ($type === false || ($type !== false && $type == 0)))
		return true;
	if ("sizecategory" == $shortTName && ($type === false || ($type !== false && $type == 0)))
		return true;
	if ("Workload" == $shortTName && ($type === false || ($type !== false && $type == 3)))
		return true;
	if ("time" == $shortTName && ($type === false || ($type !== false && $type == 0)))
		return true;
	if ("tbl_sme" == $shortTName && ($type === false || ($type !== false && $type == 0)))
		return true;
	if ("emptime" == $shortTName && ($type === false || ($type !== false && $type == 0)))
		return true;
	if ("timezone" == $shortTName && ($type === false || ($type !== false && $type == 0)))
		return true;
	if ("color" == $shortTName && ($type === false || ($type !== false && $type == 0)))
		return true;
	if ("customerallocation1" == $shortTName && ($type === false || ($type !== false && $type == 1)))
		return true;
	if ("size" == $shortTName && ($type === false || ($type !== false && $type == 0)))
		return true;
	if ("tbl_resource_allocation" == $shortTName && ($type === false || ($type !== false && $type == 0)))
		return true;
	return false;
}
...
function GetTablesList($pdfMode = false) {
	$arr = array ();
	$strPerm = GetUserPermissions ( "customer_header" );
	if (strpos ( $strPerm, "P" ) !== false || ($pdfMode && strpos ( $strPerm, "S" ) !== false)) {
		$arr [] = "customer_header";
	}
	$strPerm = GetUserPermissions ( "customer_platform" );
	if (strpos ( $strPerm, "P" ) !== false || ($pdfMode && strpos ( $strPerm, "S" ) !== false)) {
		$arr [] = "customer_platform";
	}
	$strPerm = GetUserPermissions ( "customer_stage" );
	if (strpos ( $strPerm, "P" ) !== false || ($pdfMode && strpos ( $strPerm, "S" ) !== false)) {
		$arr [] = "customer_stage";
	}
	$strPerm = GetUserPermissions ( "customer_resource_allocation" );
	if (strpos ( $strPerm, "P" ) !== false || ($pdfMode && strpos ( $strPerm, "S" ) !== false)) {
		$arr [] = "customer_resource_allocation";
	}
	$strPerm = GetUserPermissions ( "employee_auth" );
	if (strpos ( $strPerm, "P" ) !== false || ($pdfMode && strpos ( $strPerm, "S" ) !== false)) {
		$arr [] = "employee_auth";
	}
	$strPerm = GetUserPermissions ( "employee_header" );
	if (strpos ( $strPerm, "P" ) !== false || ($pdfMode && strpos ( $strPerm, "S" ) !== false)) {
		$arr [] = "employee_header";
	}
	$strPerm = GetUserPermissions ( "lookup" );
	if (strpos ( $strPerm, "P" ) !== false || ($pdfMode && strpos ( $strPerm, "S" ) !== false)) {
		$arr [] = "lookup";
	}
	...
	$strPerm = GetUserPermissions ( "customerallocation" );
	if (strpos ( $strPerm, "P" ) !== false || ($pdfMode && strpos ( $strPerm, "S" ) !== false)) {
		$arr [] = "customerallocation";
	}
	$strPerm = GetUserPermissions ( "backup" );
	if (strpos ( $strPerm, "P" ) !== false || ($pdfMode && strpos ( $strPerm, "S" ) !== false)) {
		$arr [] = "backup";
	}
	$strPerm = GetUserPermissions ( "database" );
	if (strpos ( $strPerm, "P" ) !== false || ($pdfMode && strpos ( $strPerm, "S" ) !== false)) {
		$arr [] = "database";
	}
	$strPerm = GetUserPermissions ( "application" );
	if (strpos ( $strPerm, "P" ) !== false || ($pdfMode && strpos ( $strPerm, "S" ) !== false)) {
		$arr [] = "application";
	}
	$strPerm = GetUserPermissions ( "stage" );
	if (strpos ( $strPerm, "P" ) !== false || ($pdfMode && strpos ( $strPerm, "S" ) !== false)) {
		$arr [] = "stage";
	}
	$strPerm = GetUserPermissions ( "CUST_ALLOC" );
	if (strpos ( $strPerm, "P" ) !== false || ($pdfMode && strpos ( $strPerm, "S" ) !== false)) {
		$arr [] = "CUST_ALLOC";
	}
	$strPerm = GetUserPermissions ( "calandar" );
	if (strpos ( $strPerm, "P" ) !== false || ($pdfMode && strpos ( $strPerm, "S" ) !== false)) {
		$arr [] = "calandar";
	}
	$strPerm = GetUserPermissions ( "MRP Dashboard" );
	if (strpos ( $strPerm, "P" ) !== false || ($pdfMode && strpos ( $strPerm, "S" ) !== false)) {
		$arr [] = "MRP Dashboard";
	}
	$strPerm = GetUserPermissions ( "allocation" );
	if (strpos ( $strPerm, "P" ) !== false || ($pdfMode && strpos ( $strPerm, "S" ) !== false)) {
		$arr [] = "allocation";
	}
	...
	$strPerm = GetUserPermissions ( "skillstable" );
	if (strpos ( $strPerm, "P" ) !== false || ($pdfMode && strpos ( $strPerm, "S" ) !== false)) {
		$arr [] = "skillstable";
	}
	$strPerm = GetUserPermissions ( "employeeskills" );
	if (strpos ( $strPerm, "P" ) !== false || ($pdfMode && strpos ( $strPerm, "S" ) !== false)) {
		$arr [] = "employeeskills";
	}
	$strPerm = GetUserPermissions ( "skilllevel" );
	if (strpos ( $strPerm, "P" ) !== false || ($pdfMode && strpos ( $strPerm, "S" ) !== false)) {
		$arr [] = "skilllevel";
	}
	...
	$strPerm = GetUserPermissions ( "customer_Geotag" );
	if (strpos ( $strPerm, "P" ) !== false || ($pdfMode && strpos ( $strPerm, "S" ) !== false)) {
		$arr [] = "customer_Geotag";
	}
	$strPerm = GetUserPermissions ( "tbl_test center" );
	if (strpos ( $strPerm, "P" ) !== false || ($pdfMode && strpos ( $strPerm, "S" ) !== false)) {
		$arr [] = "tbl_test center";
	}
	$strPerm = GetUserPermissions ( "tbl_director" );
	if (strpos ( $strPerm, "P" ) !== false || ($pdfMode && strpos ( $strPerm, "S" ) !== false)) {
		$arr [] = "tbl_director";
	}
	$strPerm = GetUserPermissions ( "stage2" );
	if (strpos ( $strPerm, "P" ) !== false || ($pdfMode && strpos ( $strPerm, "S" ) !== false)) {
		$arr [] = "stage2";
	}
	$strPerm = GetUserPermissions ( "tbl_categorytechnology" );
	if (strpos ( $strPerm, "P" ) !== false || ($pdfMode && strpos ( $strPerm, "S" ) !== false)) {
		$arr [] = "tbl_categorytechnology";
	}
	$strPerm = GetUserPermissions ( "tbl_technologycustomer" );
	if (strpos ( $strPerm, "P" ) !== false || ($pdfMode && strpos ( $strPerm, "S" ) !== false)) {
		$arr [] = "tbl_technologycustomer";
	}
	$strPerm = GetUserPermissions ( "customertechnology" );
	if (strpos ( $strPerm, "P" ) !== false || ($pdfMode && strpos ( $strPerm, "S" ) !== false)) {
		$arr [] = "customertechnology";
	}
	$strPerm = GetUserPermissions ( "tbl_role" );
	if (strpos ( $strPerm, "P" ) !== false || ($pdfMode && strpos ( $strPerm, "S" ) !== false)) {
		$arr [] = "tbl_role";
	}
	$strPerm = GetUserPermissions ( "sizecategory" );
	if (strpos ( $strPerm, "P" ) !== false || ($pdfMode && strpos ( $strPerm, "S" ) !== false)) {
		$arr [] = "sizecategory";
	}
	$strPerm = GetUserPermissions ( "Workload" );
	if (strpos ( $strPerm, "P" ) !== false || ($pdfMode && strpos ( $strPerm, "S" ) !== false)) {
		$arr [] = "Workload";
	}
	$strPerm = GetUserPermissions ( "time" );
	if (strpos ( $strPerm, "P" ) !== false || ($pdfMode && strpos ( $strPerm, "S" ) !== false)) {
		$arr [] = "time";
	}
	$strPerm = GetUserPermissions ( "tbl_sme" );
	if (strpos ( $strPerm, "P" ) !== false || ($pdfMode && strpos ( $strPerm, "S" ) !== false)) {
		$arr [] = "tbl_sme";
	}
	$strPerm = GetUserPermissions ( "emptime" );
	if (strpos ( $strPerm, "P" ) !== false || ($pdfMode && strpos ( $strPerm, "S" ) !== false)) {
		$arr [] = "emptime";
	}
	$strPerm = GetUserPermissions ( "timezone" );
	if (strpos ( $strPerm, "P" ) !== false || ($pdfMode && strpos ( $strPerm, "S" ) !== false)) {
		$arr [] = "timezone";
	}
	$strPerm = GetUserPermissions ( "color" );
	if (strpos ( $strPerm, "P" ) !== false || ($pdfMode && strpos ( $strPerm, "S" ) !== false)) {
		$arr [] = "color";
	}
	$strPerm = GetUserPermissions ( "customerallocation1" );
	if (strpos ( $strPerm, "P" ) !== false || ($pdfMode && strpos ( $strPerm, "S" ) !== false)) {
		$arr [] = "customerallocation1";
	}
	$strPerm = GetUserPermissions ( "size" );
	if (strpos ( $strPerm, "P" ) !== false || ($pdfMode && strpos ( $strPerm, "S" ) !== false)) {
		$arr [] = "size";
	}
	$strPerm = GetUserPermissions ( "tbl_resource_allocation" );
	if (strpos ( $strPerm, "P" ) !== false || ($pdfMode && strpos ( $strPerm, "S" ) !== false)) {
		$arr [] = "tbl_resource_allocation";
	}
	$strPerm = GetUserPermissions ( "engagementstat" );
	if (strpos ( $strPerm, "P" ) !== false || ($pdfMode && strpos ( $strPerm, "S" ) !== false)) {
		$arr [] = "engagementstat";
	}
	return $arr;
		...
		if ($iNumberOfRows) {
			if ($sFormat == FORMAT_TIME) {
				if ($value) {
					...
					$value = ($d != 0 ? $d . 'd ' : '') . mysprintf ( "%02d:%02d:%02d", array (
							$h,
							$m,
							$s 
					) );
 ...
 * Replace ' with \' and linebreaks with \r\n
 * @intellisense
 */
...
/**
 * DEPRECATED.
 * Use RunnerPage::keysSQLExpression instead
 * Construct WHERE clause with key values
 *
 * @param &Array $keys        	
 * @param String $table
 *        	Teh data source table name OPTIONAL
 *        	
 * @return String @intellisense
 * @deprecated
 *
...
function NeedQuotesNumeric($type) {
	if ($type == 203 || $type == 8 || $type == 129 || $type == 130 || $type == 7 || $type == 133 || $type == 134 || $type == 135 || $type == 201 || $type == 205 || $type == 200 || $type == 202 || $type == 72 || $type == 13)
		return true;
	else
		return false;
}
...
function IsNumberType($type) {
	if ($type == 20 || $type == 14 || $type == 5 || $type == 10 || $type == 6 || $type == 3 || $type == 131 || $type == 4 || $type == 2 || $type == 16 || $type == 21 || $type == 19 || $type == 18 || $type == 17 || $type == 139 || $type == 11)
		return true;
	return false;
}
...
function ReadUserPermissions($userID = "") {
	...
	if ($userID != "Guest") {
		...
		if (! $caseInsensitiveUsername) {
			$sql = "select " . $grConnection->addFieldWrappers ( "GroupID" ) . ", " . $grConnection->addFieldWrappers ( "UserName" ) . " from " . $grConnection->addTableWrappers ( "codis_ugmembers" ) . " where " . $grConnection->addFieldWrappers ( "UserName" ) . "=" . $grConnection->prepareString ( $userID );
		} else {
			$sql = "select " . $grConnection->addFieldWrappers ( "GroupID" ) . ", " . $grConnection->addFieldWrappers ( "UserName" ) . " from " . $grConnection->addTableWrappers ( "codis_ugmembers" ) . " where " . $grConnection->addFieldWrappers ( "UserName" ) . "=" . strtoupper ( $grConnection->prepareString ( $userID ) );
		}
	...
	$sql = "select " . $rConnection->addFieldWrappers ( "TableName" ) . ", " . $rConnection->addFieldWrappers ( "AccessMask" ) . " from " . $rConnection->addTableWrappers ( "codis_ugrights" ) . " where " . $rConnection->addFieldWrappers ( "GroupID" ) . " in (" . $groupstr . ")";
...
function guestHasPermissions() {
	...
	if (! count ( $_SESSION ["UserRights"] ["Guest"] ))
		return false;
	if (array_key_exists ( "customer_header", $_SESSION ["UserRights"] ["Guest"] ))
		return true;
	if (array_key_exists ( "customer_platform", $_SESSION ["UserRights"] ["Guest"] ))
		return true;
	if (array_key_exists ( "customer_stage", $_SESSION ["UserRights"] ["Guest"] ))
		return true;
	if (array_key_exists ( "customer_resource_allocation", $_SESSION ["UserRights"] ["Guest"] ))
		return true;
	if (array_key_exists ( "employee_auth", $_SESSION ["UserRights"] ["Guest"] ))
		return true;
	if (array_key_exists ( "employee_header", $_SESSION ["UserRights"] ["Guest"] ))
		return true;
	if (array_key_exists ( "lookup", $_SESSION ["UserRights"] ["Guest"] ))
		return true;
	...
	if (array_key_exists ( "admin_users", $_SESSION ["UserRights"] ["Guest"] ))
		return true;
	if (array_key_exists ( "customerallocation", $_SESSION ["UserRights"] ["Guest"] ))
		return true;
	if (array_key_exists ( "backup", $_SESSION ["UserRights"] ["Guest"] ))
		return true;
	if (array_key_exists ( "database", $_SESSION ["UserRights"] ["Guest"] ))
		return true;
	if (array_key_exists ( "application", $_SESSION ["UserRights"] ["Guest"] ))
		return true;
	if (array_key_exists ( "stage", $_SESSION ["UserRights"] ["Guest"] ))
		return true;
	if (array_key_exists ( "CUST_ALLOC", $_SESSION ["UserRights"] ["Guest"] ))
		return true;
	if (array_key_exists ( "calandar", $_SESSION ["UserRights"] ["Guest"] ))
		return true;
	if (array_key_exists ( "MRP Dashboard", $_SESSION ["UserRights"] ["Guest"] ))
		return true;
	if (array_key_exists ( "allocation", $_SESSION ["UserRights"] ["Guest"] ))
		return true;
	if (array_key_exists ( "View", $_SESSION ["UserRights"] ["Guest"] ))
		return true;
	if (array_key_exists ( "skillstable", $_SESSION ["UserRights"] ["Guest"] ))
		return true;
	if (array_key_exists ( "employeeskills", $_SESSION ["UserRights"] ["Guest"] ))
		return true;
	if (array_key_exists ( "skilllevel", $_SESSION ["UserRights"] ["Guest"] ))
		return true;
	if (array_key_exists ( "category", $_SESSION ["UserRights"] ["Guest"] ))
		return true;
	if (array_key_exists ( "customer_Geotag", $_SESSION ["UserRights"] ["Guest"] ))
		return true;
	if (array_key_exists ( "tbl_test center", $_SESSION ["UserRights"] ["Guest"] ))
		return true;
	if (array_key_exists ( "tbl_director", $_SESSION ["UserRights"] ["Guest"] ))
		return true;
	if (array_key_exists ( "stage2", $_SESSION ["UserRights"] ["Guest"] ))
		return true;
	if (array_key_exists ( "tbl_categorytechnology", $_SESSION ["UserRights"] ["Guest"] ))
		return true;
	if (array_key_exists ( "tbl_technologycustomer", $_SESSION ["UserRights"] ["Guest"] ))
		return true;
	if (array_key_exists ( "customertechnology", $_SESSION ["UserRights"] ["Guest"] ))
		return true;
	if (array_key_exists ( "tbl_role", $_SESSION ["UserRights"] ["Guest"] ))
		return true;
	if (array_key_exists ( "sizecategory", $_SESSION ["UserRights"] ["Guest"] ))
		return true;
	if (array_key_exists ( "Workload", $_SESSION ["UserRights"] ["Guest"] ))
		return true;
	if (array_key_exists ( "time", $_SESSION ["UserRights"] ["Guest"] ))
		return true;
	if (array_key_exists ( "tbl_sme", $_SESSION ["UserRights"] ["Guest"] ))
		return true;
	if (array_key_exists ( "emptime", $_SESSION ["UserRights"] ["Guest"] ))
		return true;
	if (array_key_exists ( "timezone", $_SESSION ["UserRights"] ["Guest"] ))
		return true;
	if (array_key_exists ( "color", $_SESSION ["UserRights"] ["Guest"] ))
		return true;
	if (array_key_exists ( "customerallocation1", $_SESSION ["UserRights"] ["Guest"] ))
		return true;
	if (array_key_exists ( "tbl_director1", $_SESSION ["UserRights"] ["Guest"] ))
		return true;
	if (array_key_exists ( "tbl_resource_allocation", $_SESSION ["UserRights"] ["Guest"] ))
		return true;
	if (array_key_exists ( "size", $_SESSION ["UserRights"] ["Guest"] ))
		return true;
	if (array_key_exists ( "engagementstat", $_SESSION ["UserRights"] ["Guest"] ))
		return true;
	return false;
}
...
function AfterFBLogIn($pUsername, $pPassword, &$pageObject = null) {
	...
	$strSQL = "select * from " . $connection->addTableWrappers ( "users" ) . " where " . $connection->addFieldWrappers ( $cUserNameField ) . "=" . $strUsername . "";
 ...
 * @param
 *        	{object} fetched row from DB with user data
 * @param
 *        	{object} page object
 *        	@intellisense
 */
function SetAuthSessionData($pUsername, &$data, $fromFacebook, $password, &$pageObject = null) {
	...
	$_SESSION ["OwnerID"] = $data ["AutUserID"];
	$_SESSION ["_users_OwnerID"] = $data ["AutUserID"];
...
function CheckSecurity($strValue, $strAction, $table = "") {
	...
	if ($localAction == "add" && ! (strpos ( $strPerm, "A" ) === false) || $localAction == "edit" && ! (strpos ( $strPerm, "E" ) === false) || $localAction == "delete" && ! (strpos ( $strPerm, "D" ) === false) || $localAction == "search" && ! (strpos ( $strPerm, "S" ) === false) || $localAction == "import" && ! (strpos ( $strPerm, "I" ) === false) || $localAction == "export" && ! (strpos ( $strPerm, "P" ) === false))
		return true;
	else
		return false;
	return true;
...
function SecuritySQL($strAction, $table = "", $strPerm = "") {
	...
	if ($strAction == "Edit" && ! (strpos ( $strPerm, "E" ) === false) || $strAction == "Delete" && ! (strpos ( $strPerm, "D" ) === false) || $strAction == "Search" && ! (strpos ( $strPerm, "S" ) === false) || $strAction == "Export" && ! (strpos ( $strPerm, "P" ) === false))
		return $ret;
	else
		return "1=0";
	return "";
 ...
 *        	Mixed value
 * @param
 *        	String table The datasource table name
 * @param
 *        	String type
 *        	@intellisense
 */
...
function prepare_for_db($field, $value, $controltype = "", $postfilename = "", $table = "") {
	...
	if ((! $controltype || $controltype == "multiselect") && ! IsTimeType ( $type )) {
		...
		if ($dformat == EDIT_DATE_SIMPLE || $dformat == EDIT_DATE_SIMPLE_INLINE || $dformat == EDIT_DATE_SIMPLE_DP) {
			...
			return mysprintf ( "%04d-%02d-%02d", array (
					$y,
					$m,
					$d 
			) );
	...
	foreach ( $deleted_values as $field => $value ) {
		if (($pSet->getEditFormat ( $field ) == EDIT_FORMAT_FILE || $pSet->getPageTypeByFieldEditFormat ( $field, EDIT_FORMAT_FILE ) != "") && $pSet->isDeleteAssociatedFile ( $field )) {
			...
			if (! is_array ( $filesArray ) || count ( $filesArray ) == 0) {
				$filesArray = array (
						array (
								"name" => $pSet->getUploadFolder ( $field ) . $value 
						) 
				);
 ...
 *        	- 24 or 12 hours format for timePicker
 * @param boolean $useTimePicker
...
function isEncryptionEnabled() {
	return GetGlobalData ( "isUseEncryption", ENCRYPTION_NONE ) == ENCRYPTION_PHP || GetGlobalData ( "isUseEncryption", ENCRYPTION_NONE ) == ENCRYPTION_DB;
}
...
function MobileDetected() {
	...
	if (preg_match ( '/(ipad|android|symbianos|opera mini|ipod|blackberry|' . 'palm os|palm|hiptop|avantgo|plucker|xiino|blazer|elaine|iris|3g_t|' . 'windows ce|opera mobi|windows ce; smartphone;|windows ce; iemobile|' . 'mini 9.5|vx1000|lge |m800|e860|u940|ux840|compal|' . 'wireless| mobi|ahong|lg380|lgku|lgu900|lg210|lg47|lg920|lg840|' . 'lg370|sam-r|mg50|s55|g83|t66|vx400|mk99|d615|d763|el370|sl900|' . 'mp500|samu3|samu4|vx10|xda_|samu5|samu6|samu7|samu9|a615|b832|' . 'm881|s920|n210|s700|c-810|_h797|mob-x|sk16d|848b|mowser|s580|' . 'r800|471x|v120|rim8|c500foma:|160x|x160|480x|x640|t503|w839|' . 'i250|sprint|w398samr810|m5252|c7100|mt126|x225|s5330|s820|' . 'htil-g1|fly v71|s302|-x113|novarra|k610i|-three|8325rc|8352rc|' . 'sanyo|vx54|c888|nx250|n120|mtk |c5588|s710|t880|c5005|i;458x|' . 'p404i|s210|c5100|teleca|s940|c500|s590|foma|samsu|vx8|vx9|a1000|' . '_mms|myx|a700|gu1100|bc831|e300|ems100|me701|me702m-three|sd588|' . 's800|8325rc|ac831|mw200|brew |d88|htc\/|htc_touch|355x|m50|km100|' . 'd736|p-9521|telco|sl74|ktouch|m4u\/|me702|8325rc|kddi|phone|lg |' . 'sonyericsson|samsung|240x|x320vx10|nokia|sony cmd|motorola|' . 'up.browser|up.link|mmp|symbian|smartphone|midp|wap|vodafone|o2|' . 'pocket|kindle|silk|hpwos|mobile|psp|treo)/', $user_agent )) {
 ...
 * 
 * @param
 *        	{string} tableName the short table name (may be empty)
 * @param
 *        	{string} pageType the page's type
 * @param
 *        	{string} suffixName (optional) It could contain a section/tab name or a pages layout's suffix (eg 'success')
...
function getLatLngByAddr($addr) {
	switch (getMapProvider ()) {
		...
		case OPEN_STREET_MAPS :
			$url = 'http://nominatim.openstreetmap.org/search/' . rawurlencode ( $addr ) . '?format=json&addressdetails=1&limit=1';
			$result = my_json_decode ( myurl_get_contents ( $url ) );
			if ($result) {
				$lat = $result [0] ['lat'];
				if (! $lat)
 ...
 * 
 * @param {array} $arr
 *        	array of inserting values
 * @param {bool} $searchId
 *        	- find last inserted id or not
...
function GetBaseScriptsForPage($isDisplayLoading, $additionalScripts = "", $customText = "") {
	...
	$result .= "<script type=\"text/javascript\" src=\"" . GetRootPathForResources ( "include/jquery-ui/external/jquery/jquery.js" ) . "\"></script>";
	$result .= "<script type=\"text/javascript\" src= \"" . GetRootPathForResources ( "include/jquery-ui/jquery-ui.js" ) . "\"></script>";
	$result .= "<script type=\"text/javascript\" src= \"" . GetRootPathForResources ( "include/jquery-ui/jquery-ui.min.js" ) . "\"></script>";
	
	$result .= "<script type=\"text/javascript\" src=\"" . GetRootPathForResources ( "include/jquery-ui/pqgrid.min.js" ) . "\"></script>";
	// $result .= "<script type=\"text/javascript\" src=\"".GetRootPathForResources("include/jquery-ui/pqselect.min.js")."\"></script>";
	// $result .= "<script type=\"text/javascript\" src=\"".GetRootPathForResources("include/runnerJS/pqselect.dev.js")."\"></script>";
 ...
 *        	Mixed data
 * @param
 *        	Bolean plainJSON (optional) The flag indicating that the JSON's html special chars mustn't be convarted
 * @return String
 */
...
function isIOS() {
	return stripos ( $_SERVER ['HTTP_USER_AGENT'], "iPod" ) !== false || stripos ( $_SERVER ['HTTP_USER_AGENT'], "iPad" ) !== false || stripos ( $_SERVER ['HTTP_USER_AGENT'], "iPhone" ) !== false;
}
...
function xt_showchart($params) {
	...
	$chartParams ['xmlFile'] = GetTableLink ( "dchartdata" ) . '?chartname=' . $params ["chartname"] . $chartPreview . '&ctype=' . $params ["ctype"] . '&showDetails=' . $showDetails;
