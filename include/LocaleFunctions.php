...
function localtime2db($strtime) {
	...
	return mysprintf ( "%02d:%02d:%02d", array (
			$h,
			$m,
			$s 
	) );
 ...
 * 
 * @param
 *        	{array} time - array(year, month, day, hour, minute, second)
 * @param
 *        	{int} firstdayofweek - the first day of the week. 0 - monday, 6 - sunday, -1 - use system settings
 *        	@intellisense
 */
 ...
 *        	{int} year
 * @param
 *        	{int} month - values 0-12, 0 - December, 1 - January, ..., 12 - December again
 *        	@intellisense
 */
 ...
 * 
 * @param
 *        	{array} time1 - array(year, month, day, hour, minute, second)
 * @param
 *        	{array} time2 - array(year, month, day, hour, minute, second)
 ...
 * 
 * @param
 *        	{array} datePart - array(year, month, day, 0,0,0)
 * @param
 *        	{array} timePart - array(0, 0, 0, hour, minute, second)
 ...
 *        	{number} hours
 * @param
 *        	{array} dateArray Date-time array
 * @return {array}
 *
 */
 ...
 *        	{number} numDay
 * @param
 *        	{string} format "dddd" - Monday, "ddd" - Mon
 * @return {string}
 *
 */
 ...
 *        	{number} numMon
 * @param
 *        	{string} format "MMMM" - December, "MMM" - Dec
 * @return {string}
 *
 */
