...
{
	var $logTableName="codisv80_audit";
	var $params;
	...
	{
		if($table=="customer_header")
		{
			return false;
		}
		if($table=="customer_platform")
		{
			return false;
		}
		if($table=="customer_stage")
		{
			return false;
		}
		if($table=="customer_resource_allocation")
		{
			return false;
		}
		if($table=="employee_auth")
		{
			return false;
		}
		if($table=="employee_header")
		{
			return false;
		}
		if($table=="lookup")
		...
		if($table=="customer_Geotag")
		{
			return false;
		}
		if($table=="tbl_test center")
		{
			return false;
		}
		if($table=="tbl_director")
		{
			return false;
		}
		if($table=="stage2")
		...
		if($table=="tbl_categorytechnology")
		{
			return false;
		}
		if($table=="tbl_technologycustomer")
		{
			return false;
		}
		if($table=="customertechnology")
		{
			return false;
		}
		if($table=="tbl_role")
		...
		if($table=="customerallocation1")
		{
			return false;
		}
		if($table=="tbl_resource_allocation")
		{
			return false;
		}
		if($table=="size")
