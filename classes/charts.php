...
class Chart
{
	...
	protected function isProjectDB()
	{
		...
		if("customer_header" == $this->chrt_array['tables'][0])
			return true;
		if("customer_platform" == $this->chrt_array['tables'][0])
			return true;
		if("customer_stage" == $this->chrt_array['tables'][0])
			return true;
		if("customer_resource_allocation" == $this->chrt_array['tables'][0])
			return true;
		if("employee_auth" == $this->chrt_array['tables'][0])
			return true;
		if("employee_header" == $this->chrt_array['tables'][0])
			return true;
		if("lookup" == $this->chrt_array['tables'][0])
			return true;
		if("codis_ugrights" == $this->chrt_array['tables'][0])
			return true;
		...
		if("users" == $this->chrt_array['tables'][0])
			return true;
		if("customerallocation" == $this->chrt_array['tables'][0])
			return true;
		if("backup" == $this->chrt_array['tables'][0])
			return true;
		if("database" == $this->chrt_array['tables'][0])
			return true;
		...
		if("customerallocation" == $this->chrt_array['tables'][0])
			return true;
		if("calandar" == $this->chrt_array['tables'][0])
			return true;
		if("" == $this->chrt_array['tables'][0])
			return true;
		if("allocation" == $this->chrt_array['tables'][0])
			return true;
		if("customerallocation" == $this->chrt_array['tables'][0])
			return true;
		if("skillstable" == $this->chrt_array['tables'][0])
			return true;
		if("employeeskills" == $this->chrt_array['tables'][0])
			return true;
		if("skilllevel" == $this->chrt_array['tables'][0])
			return true;
		if("category" == $this->chrt_array['tables'][0])
			return true;
		if("customer_header" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_test center" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_director" == $this->chrt_array['tables'][0])
			return true;
		if("stage2" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_categorytechnology" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_technologycustomer" == $this->chrt_array['tables'][0])
			return true;
		if("customertechnology" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_role" == $this->chrt_array['tables'][0])
			return true;
		if("sizecategory" == $this->chrt_array['tables'][0])
			return true;
		if("customerallocation" == $this->chrt_array['tables'][0])
			return true;
		if("time" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_sme" == $this->chrt_array['tables'][0])
			return true;
		if("emptime" == $this->chrt_array['tables'][0])
			return true;
		if("timezone" == $this->chrt_array['tables'][0])
			return true;
		if("color" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_director" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_director" == $this->chrt_array['tables'][0])
			return true;
		if("size" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_allocation_input" == $this->chrt_array['tables'][0])
			return true;
		if("" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_resource_allocation" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
