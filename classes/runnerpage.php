...
class RunnerPage {
	 ...
	 * 
	 * @var object @objtype{SearchClause}
	 *      @intellisense
	 */
	...
	/**
	 * Flag.
	 * True if fillSetCntrlMaps already called
	 * @intellisense
	 */
	...
	function RunnerPage(&$params) {
		...
		$this->settingsMap ['tableSettings'] ['entityType'] = array (
				"default" => 0,
				"jsName" => "entityType" 
		);
		$this->settingsMap ['tableSettings'] ['hasEvents'] = array (
				"default" => false,
				"jsName" => "hasEvents" 
		);
		$this->settingsMap ["tableSettings"] ["strCaption"] = array (
				"default" => "",
				"jsName" => "strCaption" 
		);
		$this->settingsMap ["tableSettings"] ["isUseAudio"] = array (
				"default" => false,
				"jsName" => "isUseAudio" 
		); // fix it
		$this->settingsMap ["tableSettings"] ["isUseVideo"] = array (
				"default" => false,
				"jsName" => "isUseVideo" 
		);
		$this->settingsMap ['tableSettings'] ['listGridLayout'] = array (
				"default" => gltHORIZONTAL,
				"jsName" => "listGridLayout" 
		);
		$this->settingsMap ["tableSettings"] ["rowHighlite"] = array (
				"default" => false,
				"jsName" => "isUseHighlite" 
		);
		$this->settingsMap ["tableSettings"] ["isUseToolTips"] = array (
				"default" => false,
				"jsName" => "isUseToolTips" 
		);
		$this->settingsMap ['tableSettings'] ['recsPerRowList'] = array (
				"default" => 1,
				"jsName" => "recsPerRowList" 
		);
		$this->settingsMap ["tableSettings"] ["showAddInPopup"] = array (
				"default" => false,
				"jsName" => "showAddInPopup" 
		);
		$this->settingsMap ["tableSettings"] ["showEditInPopup"] = array (
				"default" => false,
				"jsName" => "showEditInPopup" 
		);
		$this->settingsMap ["tableSettings"] ["showViewInPopup"] = array (
				"default" => false,
				"jsName" => "showViewInPopup" 
		);
		$this->settingsMap ["tableSettings"] ["isResizeColumns"] = array (
				"default" => false,
				"jsName" => "isUseResize" 
		);
		$this->settingsMap ["tableSettings"] ["detailsLinksOnList"] = array (
				"default" => DL_SINGLE,
				"jsName" => "detailsLinksOnList" 
		);
		$this->settingsMap ['tableSettings'] ['isUsebuttonHandlers'] = array (
				"default" => false,
				"jsName" => "isUseButtons" 
		);
		...
		$this->settingsMap ["tableSettings"] ["isUseAjaxSuggest"] = array (
				"default" => $ajaxSuggestDefault,
				"jsName" => "ajaxSuggest" 
		);
		...
		$this->settingsMap ["fieldSettings"] ["UseTimestamp"] = array (
				"default" => false,
				"jsName" => "isUseTimeStamp" 
		);
		$this->settingsMap ["fieldSettings"] ["strName"] = array (
				"default" => "",
				"jsName" => "strName" 
		);
		$this->settingsMap ["fieldSettings"] ["ShowTime"] = array (
				"default" => false,
				"jsName" => "showTime" 
		);
		$this->settingsMap ["fieldSettings"] ["EditFormat"] = array (
				"default" => "",
				"jsName" => "editFormat" 
		);
		$this->settingsMap ["fieldSettings"] ["DateEditType"] = array (
				"default" => EDIT_DATE_SIMPLE,
				"jsName" => "dateEditType" 
		);
		$this->settingsMap ["fieldSettings"] ["RTEType"] = array (
				"default" => "",
				"jsName" => "RTEType" 
		);
		$this->settingsMap ["fieldSettings"] ["ViewFormat"] = array (
				"default" => "",
				"jsName" => "viewFormat" 
		);
		$this->settingsMap ["fieldSettings"] ["validateAs"] = array (
				"default" => null,
				"jsName" => "validation" 
		);
		$this->settingsMap ["fieldSettings"] ["strEditMask"] = array (
				"default" => null,
				"jsName" => "mask" 
		);
		$this->settingsMap ["fieldSettings"] ["LastYearFactor"] = array (
				"default" => 10,
				"jsName" => "lastYear" 
		);
		$this->settingsMap ["fieldSettings"] ["InitialYearFactor"] = array (
				"default" => 100,
				"jsName" => "initialYear" 
		);
		$this->settingsMap ["fieldSettings"] ["ShowListOfThumbnails"] = array (
				"default" => false,
				"jsName" => "showListOfThumbnails" 
		);
		$this->settingsMap ["fieldSettings"] ["ImageWidth"] = array (
				"default" => 0,
				"jsName" => "imageWidth" 
		);
		$this->settingsMap ["fieldSettings"] ["ImageHeight"] = array (
				"default" => 0,
				"jsName" => "imageHeight" 
		);
			...
			for($i = 0; $i < count ( $this->allDetailsTablesArr ); $i ++) {
				...
				if (($this->pageType == PAGE_LIST) || ($this->pageType == PAGE_REPORT) || ($this->pageType == PAGE_CHART)) {
					...
					if ($dPermission ["search"]) {
						$this->jsSettings ['tableSettings'] [$this->tName] ['detailTables'] [$this->allDetailsTablesArr [$i] ['dDataSourceTable']] = array (
	...
	function init() {
		...
		if ($this->pageType == PAGE_LIST && ($this->mode == LIST_AJAX || $this->mode == LIST_SIMPLE) || $this->pageType == PAGE_DASHBOARD || ($this->pageType == PAGE_REPORT && $this->mode === REPORT_SIMPLE || $this->pageType == PAGE_CHART && $this->mode == CHART_SIMPLE)) {
	...
	public function isSearchSavingEnabled() {
		...
		return $this->pageType == PAGE_LIST && ($this->mode == LIST_AJAX || $this->mode == LIST_SIMPLE) || $this->pageType == PAGE_REPORT && $this->mode == REPORT_SIMPLE || $this->pageType == PAGE_CHART && $this->mode == CHART_SIMPLE;
	}
	...
	/**
	 * Check whether such a css rule exists.
	 * If It does get the existing class's name.
	...
	function addCustomCss() {
		...
		if ($gbl) {
			...
			if (! is_array ( $gbl ))
				$gbl = array (
						"begin" => '<style class="rnr-cells-css" type="text/css"> ' . $rules . ' </style>' 
				);
			else
	...
	function addMultiUploadSettings() {
		$this->settingsMap ["fieldSettings"] ["autoUpload"] = array (
				"default" => false,
				"jsName" => "autoUpload" 
		);
		$this->settingsMap ["fieldSettings"] ["acceptFileTypes"] = array (
				"default" => ".+$",
				"jsName" => "acceptFileTypes" 
		);
		$this->settingsMap ["fieldSettings"] ["CompatibilityMode"] = array (
				"default" => false,
				"jsName" => "compatibilityMode" 
		);
		$this->settingsMap ["fieldSettings"] ["maxFileSize"] = array (
				"default" => null,
				"jsName" => "maxFileSize" 
		);
		$this->settingsMap ["fieldSettings"] ["maxTotalFilesSize"] = array (
				"default" => null,
				"jsName" => "maxTotalFilesSize" 
		);
		$this->settingsMap ["fieldSettings"] ["maxNumberOfFiles"] = array (
				"default" => 1,
				"jsName" => "maxNumberOfFiles" 
		);
	}
	 ...
	 * 
	 * @param
	 *        	String mTName master table name
	 * @param
	 *        	Number recId master record id
	 * @param
	 *        	&Array data master record data
	 */
	 ...
	 * 
	 * @param
	 *        	String mPageType the master page type
	 * @param
	 *        	String mTableName the master page data source table name
	 * @param
	 *        	String mShortTableName the master page short table name
	 */
	...
	function clearSessionKeys() {
		if ($this->pageType == PAGE_LIST && ! count ( $_POST ) && (! count ( $_GET ) || count ( $_GET ) == 1 && isset ( $_GET ["menuItemId"] ) || $this->masterTable && $this->mode != LIST_DETAILS) || ($this->pageType == PAGE_CHART || $this->pageType == PAGE_REPORT || $this->pageType == PAGE_DASHBOARD) && ! count ( $_POST ) && ! count ( $_GET ) || @$_GET ["editType"] == ADD_ONTHEFLY) {
			$this->unsetAllPageSessionKeys ();
		}
		
		if ($this->pageType == PAGE_LIST && ($this->mode === LIST_DETAILS || $this->mode === LIST_LOOKUP) || ($this->pageType == PAGE_REPORT && $this->mode != REPORT_SIMPLE || $this->pageType == PAGE_CHART && $this->mode != CHART_SIMPLE)) {
	...
	function addLookupSettings() {
		$this->settingsMap ["fieldSettings"] ["parentFields"] = array (
				"default" => array (),
				"jsName" => "parentFields" 
		);
		$this->settingsMap ["fieldSettings"] ["DependentLookups"] = array (
				"default" => array (),
				"jsName" => "depLookups" 
		);
		$this->settingsMap ["fieldSettings"] ["LCType"] = array (
				"default" => LCT_DROPDOWN,
				"jsName" => "lcType" 
		);
		$this->settingsMap ["fieldSettings"] ["LookupTable"] = array (
				"default" => "",
				"jsName" => "lookupTable" 
		);
		$this->settingsMap ["fieldSettings"] ["SelectSize"] = array (
				"default" => 1,
				"jsName" => "selectSize" 
		);
		$this->settingsMap ["fieldSettings"] ["Multiselect"] = array (
				"default" => false,
				"jsName" => "Multiselect" 
		);
		$this->settingsMap ["fieldSettings"] ["LinkField"] = array (
				"default" => "",
				"jsName" => "linkField" 
		);
		$this->settingsMap ["fieldSettings"] ["DisplayField"] = array (
				"default" => "",
				"jsName" => "dispField" 
		);
		$this->settingsMap ["fieldSettings"] ["freeInput"] = array (
				"default" => false,
				"jsName" => "freeInput" 
		);
		$this->settingsMap ["fieldSettings"] ["HorizontalLookup"] = array (
				"default" => false,
				"jsName" => "HorizontalLookup" 
		);
		$this->settingsMap ["fieldSettings"] ["autoCompleteFields"] = array (
				"default" => array (),
				"jsName" => "autoCompleteFields" 
		);
	}
	 ...
	 *        	Array values
	 * @param
	 *        	EditControlsContainer controls An instance of the 'EditControlsContainer' class OPTIONAL
	 *        	
	 * @return boolean|array @intellisense
	 */
	 ...
	 *
	 * @param string $field
	 *        	The field name - can be NULL
	 * @param object $connection
	 *        	The connection object - can be NULL
	 * @param object $pSet
	 *        	The settings object - can be NULL
	 *        	
	 * @return string
	 */
	 ...
	 *        	The cypherer object - can be NULL
	 *        	
	 * @return string
	 */
	 ...
	 *        	string fName
	 * @param
	 *        	Array vals Dependent and main fields' values
	 ...
	 *
	 * @param
	 *        	Array arr an array of settings for one control
	 * @param
	 *        	Boolean addSet indicates if to add additional settings to control or not
	 * @param
	 *        	String fName (optional) a field's name
	 *        	@intellisense
	 */
	...
	function fillTimePickSettings($field, $value = "", $pSet = null, $pageType = "") {
		...
		if (count ( $timeAttrs ) && $timeAttrs ["useTimePicker"]) {
			...
			$this->fillControlsMap ( array (
					'controls' => array (
							'open' => ($tpVal ['val'] ? true : false) 
					) 
			), true, $field );
		}
	}
	...
	function AddJSFile($file, $req1 = "", $req2 = "", $req3 = "") {
		...
		if ($req1 != "") {
			$this->includes_jsreq [$rootPath] = array (
					GetRootPathForResources ( $req1 ) 
			);
		}
		if ($req2 != "") {
	...
	function addCommonJs() {
		if ($this->debugJSMode === true) {
			...
			if ($this->pSet->isAddPageEvents () && $this->pageType != PAGE_LOGIN && $this->shortTableName != "") {
				$this->AddJSFile ( "include/runnerJS/events/pageevents_" . $this->shortTableName . ".js", "include/runnerJS/pages/PageSettings.js", "include/runnerJS/button.js" );
			}
	...
	function getNextPrevRecordKeys(&$data, $securityMode, &$next, &$prev, $onDash = false) {
		...
		if ($whereData ["where_next"] == "" || $orderData ["order_next"] == "" || $whereData ["where_prev"] == "" || $orderData ["order_prev"] == "") {
			$_SESSION [$this->sessionPrefix . "_noNextPrev"] = 1;
			return;
		}
	 ...
	 * 
	 * @param
	 *        	Array fieldsList The key and orderby fields
	 * @param
	 ...
	 *        	Array fieldsList The key and orderby fields
	 * @param
	 *        	Array data The page's record data
	 * @param
	 *        	String option (optional)
	 * @return Array
	 */
	...
	protected function getPrevNextSQL(&$query, $whereData, $orderData, $onDash, $securityMode, $option = "both") {
		...
		if (! $query->HasGroupBy ()) {
			...
			$sql = "select * from " . "(" . $query->toSql ( $where, "", $this->getRefinedPageHaving ( $query, $onDash ), false, $joinFromPart ) . ") prevnextquery";
	...
	function buildDetailGridLinks(&$data) {
		...
		foreach ( $this->allDetailsTablesArr as $detailsData ) {
			...
			$hrefs [] = array (
					"id" => $this->pSet->getDPType ( $detailsData ['dDataSourceTable'] ) == DP_INLINE ? $dShortTable . "_preview" : "master_" . $dShortTable . "_",
	 ...
	 *        	{string} field name
	 * @param
	 *        	{array} associative array with record data
	 * @param
	 *        	{string} string with record keys and values
	 *        	@intellisense
	 */
	...
	function buildFilterPanel() {
		if (! $this->permis [$this->tName] ["search"] || $this->pSetEdit->isSearchRequiredForFiltering () && ! $this->isRequiredSearchRunning ()) {
			return;
		}
	...
	function displayAJAX($templatefile, $id) {
		...
		if ($this->pageType == PAGE_CHART) {
			$returnJSON ['headerCont'] = '<span class="rnr-dbebrick">' . $this->getPageTitle ( $this->pageType, GoodFieldName ( $this->tName ) ) . "</span>";
		}
	...
	static function sGetWhereComponents($query, $pSet, $searchObj, $controls, $connection, $masterTableSQLClause = "", $secSQL = false) {
		...
		$whereComponents ["commonWhere"] = combineSQLCriteria ( array (
				$query->WhereToSql (),
				$masterTableSQLClause,
				$secSQL !== false ? $secSQL : SecuritySQL ( "Search", $pSet->getTableName () ) 
		) );
		$whereComponents ["commonHaving"] = combineSQLCriteria ( array (
				$query->Having ()->toSql ( $query ) 
		) );
	 ...
	 * 
	 * @param
	 *        	Array params - asp compatibility issue
	 */
	...
	function getProceedLink() {
		...
		return '<span class="rnr-dbebrick">' . '<a href="' . $proceedLink . '" name="dp' . $this->id . '">' . "Proceed to" . ' ' . GetTableCaption ( GoodFieldName ( $this->tName ) ) . '</a>' . "&nbsp;&nbsp;</span>";
	}
	 ...
	 * 
	 * @param
	 *        	String dDataSourceTable The detail datasource table name
	 * @param
	 *        	Number dTableIndex The detail table index in the allDetailsTablesArr prop
	 * @return Boolean
	 */
	...
	public function getDetailsParams($ids) {
		...
		foreach ( $this->allDetailsTablesArr as $detailData ) {
			if (! ($this->pageType == PAGE_VIEW && $detailData ["previewOnView"] || $this->pageType == PAGE_EDIT && $detailData ["previewOnEdit"] || $this->pageType == PAGE_ADD && $detailData ["previewOnAdd"])) {
				continue;
			}
			
			$strDetTableName = $detailData ["dDataSourceTable"];
			$dpPermis = $this->getPermissions ( $strDetTableName );
			if (($this->pageType == PAGE_VIEW || $this->pageType == PAGE_EDIT) && $dpPermis ['search'] || $this->pageType == PAGE_EDIT && $dpPermis ['edit'] || $this->pageType == PAGE_ADD && $dpPermis ['add']) {
				$dpParams ['ids'] [] = ++ $ids;
	...
	protected function setDetailList($listTName, $listId, &$data) {
		...
		if ($listPageObject->isDispGrid ()) {
			...
			$this->controlsMap ["dpTablesParams"] [] = array (
					"tName" => $listTName,
					"id" => $options ["id"],
					"pType" => PAGE_LIST 
			);
	 ...
	 * 
	 * @param
	 *        	&Array inlineControlFields
	 * @param
	 *        	Number screenWidth
	 * @param
	 *        	Number screenHeight
	 * @param
	 *        	String orientation The current device orientation identifier
	 */
	 ...
	 *        	String page
	 * @param
	 *        	String table A good table name
	 * @param
	 *        	ProjectSettings pSet
	 * @return STring
	 */
	 ...
	 *        	String page
	 * @param
	 *        	String table (optional) A good table name
	 * @param
	 *        	Array record (optional) A source record data
	 * @param
	 *        	ProjectSettings settings (optional)
	 * @return String
	 */
	 ...
	 *
	 * @param
	 *        	String field name (A good field name case-sensitive)
	 * @param
	 *        	String label value
	 * @return Boolean
	 */
