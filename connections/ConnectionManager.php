...
class ConnectionManager {
	...
	protected function _setTablesConnectionIds() {
		...
		$connectionsIds ["customer_header"] = "Tables";
		$connectionsIds ["customer_platform"] = "Tables";
		$connectionsIds ["customer_stage"] = "Tables";
		$connectionsIds ["customer_resource_allocation"] = "Tables";
		$connectionsIds ["employee_auth"] = "Tables";
		$connectionsIds ["employee_header"] = "Tables";
		$connectionsIds ["lookup"] = "Tables";
		...
		$connectionsIds ["customerallocation"] = "Tables";
		$connectionsIds ["backup"] = "Tables";
		$connectionsIds ["database"] = "Tables";
		$connectionsIds ["application"] = "Tables";
		$connectionsIds ["stage"] = "Tables";
		$connectionsIds ["CUST_ALLOC"] = "Tables";
		$connectionsIds ["calandar"] = "Tables";
		$connectionsIds ["allocation"] = "Tables";
		$connectionsIds ["View"] = "Tables";
		$connectionsIds ["skillstable"] = "Tables";
		$connectionsIds ["employeeskills"] = "Tables";
		$connectionsIds ["skilllevel"] = "Tables";
		$connectionsIds ["category"] = "Tables";
		$connectionsIds ["customer_Geotag"] = "Tables";
		$connectionsIds ["tbl_test center"] = "Tables";
		$connectionsIds ["tbl_director"] = "Tables";
		$connectionsIds ["stage2"] = "Tables";
		$connectionsIds ["tbl_categorytechnology"] = "Tables";
		$connectionsIds ["tbl_technologycustomer"] = "Tables";
		$connectionsIds ["customertechnology"] = "Tables";
		$connectionsIds ["tbl_role"] = "Tables";
		$connectionsIds ["sizecategory"] = "Tables";
		$connectionsIds ["Workload"] = "Tables";
		$connectionsIds ["time"] = "Tables";
		$connectionsIds ["tbl_sme"] = "Tables";
		$connectionsIds ["emptime"] = "Tables";
		$connectionsIds ["timezone"] = "Tables";
		$connectionsIds ["color"] = "Tables";
		$connectionsIds ["customerallocation1"] = "Tables";
		$connectionsIds ["tbl_director1"] = "Tables";
		$connectionsIds ["tbl_director3"] = "Tables";
		$connectionsIds ["size"] = "Tables";
		$connectionsIds ["tbl_resource_allocation"] = "Tables";
	 ...
	 * 
	 * @param
	 *        	String dataSourceTName1
	 * @param
	 *        	String dataSourceTName2
	 * @return Boolean
	 */
