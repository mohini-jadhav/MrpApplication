...
$page_layouts ["customerallocation_list"] = $layout;
...
$layout = new TLayout ( "masterchart", "FusionAqua", "MobileAqua" );
$layout->version = 2;
$layout->blocks ["bare"] = array ();
$layout->containers ["masterchartheader"] = array ();
$layout->container_properties ["masterchartheader"] = array ();
$layout->containers ["masterchartheader"] [] = array (
		"name" => "masterchartheader",
		"block" => "",
		"substyle" => 1 
);

$layout->skins ["masterchartheader"] = "empty";

$layout->blocks ["bare"] [] = "masterchartheader";
...
$layout->blocks ["bare"] [] = "form";
$page_layouts ["Workload_masterchart"] = $layout;
